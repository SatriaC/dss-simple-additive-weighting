            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="alert alert-info alert-dismissible">
                                        ...
                                        - Jenis Benefit merupakan jenis bobot yang mengutamakan manfaat/tidak memperhitungkan uang <br>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <!-- form start -->
                        <form role="form" action="/kriteria" method="POST">
                            <div class="card-body">
                                @csrf
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bobot"
                                        ...
                                        placeholder="Masukkan Nilai Bobot" value="{{ old('bobot') }}">
                                    @error('bobot')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
